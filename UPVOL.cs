...
namespace YMM4SamplePlugin.AudioEffect
{
    ...
    /// </summary>
    [AudioEffect("(B)音量を上げる", ["条件"], [])]
    public class UPVOL : AudioEffectBase
    {
        /// <summary>
        /// エフェクトの名前
        /// </summary>
        public override string Label => "(B)音量を上げる";
        ...
        /// </summary>
        [Display(GroupName = "音量", Name = "音量", Description = "音量を上げる量")]
        [AnimationSlider("F0", "%", -100, 100)]
        public Animation Volume { get; } = new Animation(0, -10000, 10000);
        ...
        {
            return new UPVOLProcessor(this, duration);
        }
